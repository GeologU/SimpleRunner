...
import attributes_global
from attributes_global import global_attribute
...
class TestAttributeAccessKey(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeAccessKey
...
class TestAttributeClass(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeClass
...
class TestAttributeContentEditable(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeContentEditable
...
class TestAttributeDataStar(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeDataStar
...
class TestAttributeDir(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeDir
...
class TestAttributeDraggable(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeDraggable
...
class TestAttributeDropZone(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeDropZone
...
class TestAttributeHidden(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeHidden
...
class TestAttributeID(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeID
...
class TestAttributeLang(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeLang
...
class TestAttributeSpellCheck(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeSpellCheck
...
class TestAttributeStyle(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeStyle
...
class TestAttributeTabIndex(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeTabIndex
...
class TestAttributeTitle(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeTitle
...
class TestAttributeTranslate(TestAttributeBase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.attr_cls = attributes_global.AttributeTranslate
